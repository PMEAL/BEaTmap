...
def html_tables(bet_results, rouq_mask):
    """Creates and populates ASCII formatted tables of BET results.
    ...
    print('<p>Standard deviation of specific surface area = %.3f</p>' % (ssa_std))
    ...
    print(table2.get_html_string())
    print('<p>Standard deviation of BET constant (C) = %.5f</p>' % (c_std))
    return 
